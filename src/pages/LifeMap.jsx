...
export default function LifeMap({ data }) {
  ...
  return (
    <div className="p-5 md:p-8 max-w-5xl mx-auto">
      ...
      {places.length === 0 ? (
        <div className="rounded-lg border border-dashed border-ink/20 bg-receipt p-8 text-center text-sm text-ink/60 mt-8">
          <p className="font-serif text-lg text-ink">No locations found.</p>
          <p className="mt-2">None of the recorded moments contain location data.</p>
        </div>
      ) : (
