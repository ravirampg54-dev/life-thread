...
export default function ConnectionExplainer({ connection, receiptsById, onClose, onOpenReceipt }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" role="dialog" aria-modal="true" aria-labelledby="connection-explainer-title" ref={containerRef}>
      ...
      <div className="relative w-full max-w-md bg-receipt border-2 border-ink rounded-lg shadow-2xl p-5 animate-fadein">
        <div className="flex items-center justify-between mb-3">
          <h2 id="connection-explainer-title" className="font-mono text-xs uppercase tracking-widest text-ink/60">Why are these connected?</h2>
